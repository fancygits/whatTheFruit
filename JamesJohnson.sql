...
--
CREATE DATABASE IF NOT EXISTS `what_the_fruit` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `what_the_fruit`;
...
GRANT SELECT
ON what_the_fruit.fruit
TO consumer@localhost
IDENTIFIED BY '3at3r';

GRANT SELECT
ON what_the_fruit.reviews
TO consumer@localhost
IDENTIFIED BY '3at3r';

GRANT SELECT
ON what_the_fruit.messages
TO consumer@localhost
IDENTIFIED BY '3at3r';
